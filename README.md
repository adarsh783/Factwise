...
// before starting the project run yarn install and it will support node 18 and above version
// after installing all the packages run yarn start
// have not added name edit because it was not mentioned in the description
// age field is not editable because in json it is mentioned in string(1973-10-16) and then I'm converting it to years but again years to dob
conversion I couldn't get
